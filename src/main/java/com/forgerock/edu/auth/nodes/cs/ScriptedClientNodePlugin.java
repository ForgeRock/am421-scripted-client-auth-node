 ...
 * @since AM 5.5.0
 */
public class ScriptedClientNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ScriptedClientNodePlugin.currentVersion, 
				Collections.singletonList(ScriptedClientNode.class));
	}
	...
	public void onInstall() throws PluginException {
            System.err.println("[ScriptedClientNodePlugin] - onInstall() called.");
		super.onInstall();
	}
	...
	public void onStartup() throws PluginException {
            System.err.println("[ScriptedClientNodePlugin] - onStartup() called.");
		super.onStartup();
	}
	...
	public String getPluginVersion() {
		return ScriptedClientNodePlugin.currentVersion;
	}
}
